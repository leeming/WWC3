 ...
 * MySQL Class to allow easy and clean access to common mysql commands
 * @author	ricocheting
 * @link 	http://www.ricocheting.com/scripts/
 * @since 	2/2/2009
 * @version	2.1
...
class Database
{
	 ...
	 * @param	String	$pre		Optional: prefix of tables
	 */
	...
	function query($sql) {
		...
		if (!$this->query_id) {
			...
			print "ahh:".mysql_error($this->link_id);
		}
	...
	function oops($msg='') {
		...
		?>
			...
			<?php echo'<tr><td align="right" valign="top" nowrap>Back Trace:</td><td><pre>'.print_r(array_slice(debug_backtrace(),1), true).'</pre></td></tr>'; ?>
